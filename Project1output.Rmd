...
for (i in 1:nrow(distances_df)){
  cat(recent_area,"is", distances_df[i,2], " away from", distances_df[i,1],"\n")
}
```


### Objective 4 - Risk Scores (have been calculated, i will format the section tomorrow)
```{r}
library(tidyverse)
...
riskscores_sorted <- riskscores[order(riskscores$risk_score, decreasing = FALSE), ]
riskscores_sorted
